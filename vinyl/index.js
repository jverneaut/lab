...
const getSharedImgData = i => {
  ...
  const textImageData = ctx.getImageData(0, H / 2 - imgDataHeight / 2, W, imgDataHeight);

  drawCircle(((i * 2 + 1) * strokeWidth) / 2);
  const circleImageData = ctx.getImageData(0, H / 2 - imgDataHeight / 2, W, imgDataHeight);
